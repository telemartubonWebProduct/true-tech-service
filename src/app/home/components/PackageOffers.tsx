    ...
    >
      <Container maxWidth="lg">
        <Box className=" top-0 left-0 w-full h-full z-10 my-8">
          <Typography fontFamily={"Prompt"} variant="h5" component="h2" color="#ffffff">
            ...
            <SwiperSlide key={index}>
              <Link href={item.path}>
                ...
                >
                  ...
                  >
                    <Typography variant="h5" fontFamily="Prompt" fontWeight={600} sx={{ mb: 1, color: "black" }}>
                      {item.title}
                    </Typography>
                    <Typography variant="body1" fontFamily="Prompt" sx={{ color: "black" }}>
                      {item.detail}
                    </Typography>
